      ...
      compile: function(element) {
        return RecursionHelper.compile(element, function(scope, iElement,
          ...
          if (scope.graph.graphRoots.length === 0) {
            ...
            var property4 = new transformationDataModel.Property('foaf',
              'gender');

            var subNode1 = new transformationDataModel.ConstantURI(
              'foaf', 'Person');
            var subNode2 = new transformationDataModel.ColumnLiteral(
              'name');

            //var subNode3 = new transformationDataModel.ColumnLiteral('age');
            var subNode4 = new transformationDataModel.ColumnLiteral(
              'gender');
            ...
            scope.graph.addNodeAfter(null, new transformationDataModel.ColumnURI(
              '', 'person-uri', [property1, property2, property4]));
          }
