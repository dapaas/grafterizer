...
/**
 * @ngdoc function
 * @name grafterizerApp.controller:AssignDatatypeControllerCtrl
 * @description
 * # AssignDatatypeControllerCtrl
 * Controller of the grafterizerApp
 */
angular.module('grafterizerApp')
  .controller('AssignDatatypeControllerCtrl', function(
    $rootScope,$scope, transformationDataModel, $mdToast, $mdDialog) {
