...
angular.module('grafterizerApp')
  .controller('TransformationNewCtrl', function(
    ...
    var customfunctions = [
        ...
        'UNEDITABLE', 'Given a dataset and collection of column names narrows dataset to all but specified columns'),
        ...
        '(defn integer-literal [s] (Integer/parseInt s))', 'CONVERT DATATYPE', 'Coerce to integer'),
          new transformationDataModel.CustomFunctionDeclaration('fill-when', '', 'UNEDITABLE',
        ...
        '', 'STRING', 'Converts string to all upper-case'),
          new transformationDataModel.CustomFunctionDeclaration('reverse', '', 'STRING',
        'Returns given string with its characters reversed'),
          new transformationDataModel.CustomFunctionDeclaration('string-as-keyword',
        '(defn string-as-keyword [s] (when (seq s) (->   s   (clojure.string/replace " " "") (clojure.string/replace ":" "") )))',
        'STRING', 'Removes blanks and colons in a string thus making it possible to use it as a keyword'),
          new transformationDataModel.CustomFunctionDeclaration('remove-blanks',
        '(defn remove-blanks [s]  (when (seq s)  (clojure.string/replace s " " "")))', 'STRING',
        'Removes blanks in a string'),
          new transformationDataModel.CustomFunctionDeclaration('titleize',
        ...
        'STRING', 'Capitalizes each word in a string'),
          new transformationDataModel.CustomFunctionDeclaration('trim', '', 'STRING',
